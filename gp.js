...
nconf.defaults({
     ...
     "variables":['speed','distance','distancedif','weight','weightdif','goingdif'],
     'functionSet':['+','-','*','/','^','if<='],
	...
	this.eval=function(variablebindings){ 
		if(this.type=='constant'){
			...
			if(this.functionname=='+'){
				...
				return(Math.pow(argVals[0], Math.floor(argVals[1])));
			}
...
//returns a node structure by parsing a string
